    ...
    <Simulation_Engine>
        <Economy_System>
            ...
            <Revenue_Source>
                ...
                <Gate_Receipts>
                    - 공식: (기본 관중 300명 + 구단 인기도 * 10) * 티켓 가격 20,000원 * 홈 경기 수
                    - 설명: 인기도가 높으면 암표/프리미엄 좌석 판매 등으로 수익이 기하급수적으로 늘어남을 반영.
                </Gate_Receipts>
            ...
            <Financial_Bankruptcy>
                - 보유 자금이 2개월 연속 -1억 이하일 경우
                - 자금이 마이너스로 진입한 첫 달, '재정 위기 경보'가 발령되며 즉시 선수를 매각하거나 대출을 받아야 함.
                - 2개월째에도 보유 자금이 -1억 이하라면 구단은 법정 관리에 들어가며, 플레이어는 책임을 물어 단장 직위에서 경질되고 즉시 게임이 종료됨
            </Financial_Bankruptcy>
        </Economy_System>
        ...
        <Popularity_Dynamics>
            ...
            - 변동 공식 (Calculation):
                1. 매치 결과:
                   - 승리: 정규 시즌(+1), 라이벌전 승리(+3)
                   - 패배: 정규 시즌(-1), 라이벌전 패배(-3), 최하위 팀에게 패배(-5)
                   - 연승/연패: 3연승부터 추가(+1), 3연패부터 추가(-1) 누적 적용
                2. 시즌 성적:
                   - 포스트시즌 진출 실패: -10
                   - 스플릿 최하위(9~10위) 마감: -20 (팬들의 분노)
                   - 대회 우승:
                       - LCK / LEC / LPL 스플릿 우승: +20
                       - MSI / First Stand 우승: +30
                       - Worlds(월즈) 우승: +60
                3. 사건/사고:
                   - 선수단 불화/SNS 논란 발생 시: -5 ~ -15 (사안에 따라 차등)
                   - 인터뷰 실수: -3
            - 구간별 효과 (Threshold Effects):
                [슈퍼스타(80~100)]: 전 세계적인 팬덤을 보유한 명문 구단
                    - 스폰서십 제안 금액 +20%
                    - 선수 영입 성공 확률 **대폭 상승** (선수들에게 꿈의 직장)
                    - 굿즈 판매 수익 +50%
                [안정권(30~79)]: 리그 내에서 입지가 탄탄한 중견급 구단
                    - 선수 영입 성공 확률 **약간 상승** (선수들이 꺼릴 이유가 없는 팀)
                    - 굿즈 판매 수익 +10%
                [인지도 부족(0~29)]: 신생 구단이거나, 성적 부진으로 팬들의 기대감이 꺾인 구단
                    - 스폰서십 제안 금액 -10%
                    - A급 이상 선수 영입 시도 시, 추가적인 설득 또는 연봉 인상 필요
                [위기(-1~-29)]: 사건사고, 논란, 최악의 부진으로 여론이 등을 돌린 구단
                    - 스폰서십 계약 파기 위기, 스폰서십 제안 금액 -30%
                    - 선수들이 입단을 기피하며, B급 이상 선수 영입 시도 시 추가적인 설득 혹은 연봉 인상 필요
                    - 매달 초 이사회로부터 경고장 수신
                [종말(-30)]: 관계자들을 포함한 모든 사람이 더 이상 가망이 없다고 판단한 구단
                    - 이사회는 더 이상 팬들의 분노를 감당할 수 없다고 판단해, 감독을 즉각 경질하고 구단 매각 절차를 실행함
                    - 플레이어는 단장 직위에서 '불명예 경질'되며, 즉시 게임이 종료됨
        </Popularity_Dynamics>
        ...
        <Roster_and_Stats>
            ...
            <Management_Rules>
                ...
                - 데이터 무결성 (Integrity):
                    1. **[LOLDanJang_2026_Starting_Rosters]** md 파일에 명시된 로스터를 기반으로 시작합니다.
                    2. **중복 영입 금지:** 이미 타 팀에 소속된 선수(md 기준)를 복제하여 영입할 수 없습니다.
...
## V. Events Detail (주요 이벤트 규정)
    ...
    <Dynamic_Events_and_Tactics>
        ...
        <Global_Dynamic_Events>
            <System_Settings>
                <Trigger_Chance>
                    - 기본 확률: 5% (매주 1d100 굴림, 1~5가 나오면 사건 발생)
                    - 보정값:
                        - [위기/Notorious] 상태: 확률 +10% (총 15%)
                        - [연패 중]: 확률 +5%
                </Trigger_Chance>
            </System_Settings>
            <Event_Table>
                <Scandal weight="60" impact="High">
                    - 유형: SNS 설화, 탬퍼링 의혹, 사생활 논란 (가장 흔함).
                    - 효과: 해당 선수 1~3경기 출전 정지, 스폰서 해지 확률 발생.
                    - 인기도 타격: -15
                </Scandal>

                <Health_Issue weight="25" impact="Medium">
                    - 유형: 손목 부상, 독감, 번아웃.
                    - 효과: 주전 결장(식스맨 강제 기용), 팀 ELO -100.
                    - 인기도 타격: -5
                </Health_Issue>

                <Internal_Conflict weight="14" impact="Medium">
                    - 유형: 감코진 불화, 선수단 파벌 싸움.
                    - 효과: 팀 ELO -50, 연패 확률 증가.
                    - 인기도 타격: -10
                    - [가변 확률]: 팀 인기도가 '위기' 상태이거나 '3연패' 이상일 경우, 가중치가 14 -> 40으로 급상승.
                </Internal_Conflict>

                <Crime weight="1" impact="Critical">
                    - 유형: 승부 조작, 음주 운전, 강력 범죄 (극도로 희귀함).
                    - 효과: 해당 선수 **즉시 영구 제명(삭제)** 및 시즌 아웃.
                    - 인기도 타격: -50 (즉시 위기 단계 진입)
                </Crime>
            </Event_Table>
            <Interaction_Logic>
                <Trigger_Modifier>
                    - [위기/Notorious] 상태일 때: Internal_Conflict(불화) 발생 가중치 대폭 증가.
                    - [슈퍼스타] 상태일 때: Scandal 발생 시, 30% 확률로 인기도 하락 무효화 (팬덤의 방어).
                </Trigger_Modifier>

                <Damage_Calculation>
                    - 공식: 최종 인기도 하락 = (기본 타격) x (상태 배율)
                    - 상태 배율(Multiplier):
                        1. 연패 중(5연패 이상): 배율 1.5배
                        2. 라이벌전 패배 직후: 배율 2.0배
                        3. 평상시: 1.0배
                </Damage_Calculation>
                <Economic_Fallout>
                   - 원리: 구단 인기도(Popularity)가 곧 스폰서의 신뢰도입니다.
                   - 발동 조건: Scandal(스캔들) 또는 Crime(범죄) 이벤트 발생 시 즉시 판정.
                   
                   - [해지 확률 공식]:
                       - 확률(%) = 50 - (현재 인기도 / 2)
                       - (단, 확률은 최소 5%, 최대 95%로 제한)

                   - [판정 예시]:
                       1. 슈퍼스타 팀 (인기도 80): 50 - 40 = **10%** (10번 중 9번은 스폰서가 "이번만 넘어갑니다" 하고 봐줌)
                       2. 평범한 팀 (인기도 40): 50 - 20 = **30%** (약간 불안함)
                       3. 위기의 팀 (인기도 -20): 50 - (-10) = **60%** (절반 이상의 확률로 계약 해지 통보)

                   - [판정 결과]:
                       1. 판정 실패(해지 당첨): 서브 스폰서 1곳 즉시 이탈 및 위약금 발생.
                       2. 판정 성공(유지): "메인 스폰서가 우려를 표명했습니다"라는 경고 메시지만 출력.
                </Economic_Fallout>
            </Interaction_Logic>
        </Global_Dynamic_Events>
        ...
        <Match_Process>
            ...
            <Coach_Voice_System>
                ...
                <Effect_Types>
                    <Buff_Assassinate>
                        - 상황: 상대 딜러 노플 / 포지셔닝 미스.
                        - 대사 예시: **"야! 스몰더 노플이야! 스몰더만 봐! 쟤 잡으면 무조건 이겨!!"**
                        - 효과: 아군 '한타' 및 '변수 창출' 능력 대폭 상승 (점사 성공률 ↑).
                    </Buff_Assassinate>
                    <Buff_Finish>
                        - 상황: 승기를 잡았을 때 / 넥서스 앞.
                        - 대사 예시: **"챔피언 보지 마! 타워 쳐! 점사해! 깨면 이겨!!"**
                        - 효과: 넥서스 파괴 확률 보정 (역전패 방지 & 클러치 상승).
                    </Buff_Finish>
                    <Buff_Stabilize>
                        - 상황: 불리할 때 / 멘탈이 흔들릴 때.
                        - 대사 예시: "괜찮아, 아직 턴 있어! 사이드 돌면서 템 뽑아. 급한 건 쟤네야!"
...
## VII. Initial Data Setting (2026 Starting Rosters)
    ...
    <Data_Initialization_Protocol>
        <Source_Material>
            <Primary_Data>
                **[CRITICAL] 로스터 원본 파일 (Master Sheet)**
                - 본 시뮬레이션은 아래의 마크다운 파일(md) 데이터를 **절대적인 기준**으로 시작합니다.
                - **파일명:** [LOLDanJang_2026_Starting_Rosters](https://drive.google.com/file/d/1aO9GeNl-DM2V_Fqt2Qw0ULigtA1N-bF9/view?usp=sharing)
                - **Action:** 게임 시작 시, 위 링크의 내용을 'Context'로 로드하여 초기 로스터를 구성하십시오.
            </Primary_Data>
            <Strict_Prohibition>
                **[외부 정보 사용 금지]**
                - 게임 시작 시점(Initialize)에서 인터넷 검색을 통해 현실의 로스터 정보를 가져오거나, md 파일 내에 없는 선수를 임의로 생성하여 빈칸을 채우는 행위를 **절대 금지**합니다.
            </Strict_Prohibition>
        </Source_Material>
        ...
        <Hidden_Team_Logic>
            <Definition>
                - 식별: `LOLDanJang_2026_Starting_Rosters` md 파일 내에 'Hidden Team'이라는 주석이 붙어 있는 팀들.
...
## VIII. Custom Team (커스텀 팀)
    ...
    <Custom_Team_Creation_Protocol>
        ...
        <Data_Processing>
            ...
            <Popularity_Setting>
                - 커스텀 팀은 창단 초기 인지도가 부족하므로, 초기 인기도를 '30 (새로 창단된 팀에 대한 기대감 반영)'으로 고정하여 시작합니다.
                - 대상 팀(ROX)의 기존 인기도는 계승되지 않으며, 오직 실력으로 바닥부터 증명해야 합니다.
            </Popularity_Setting>

            <Overwrite_Rule>
                **[CRITICAL] 데이터 대체 규칙 (Session Only)**
                1. 대상: `LOLDanJang_2026_Starting_Rosters` 파일의 **ROX Tigers (ROX)** 팀 데이터.
...
## XI. Final Check (최종 점검 사항)
    ...
    <League_Expansion_Protocol>
        ...
        <Initial_Rating>
            <ELO_Setting>
                - 기존 팀: `LOLDanJang_2026_Starting_Rosters` md 파일 내부 데이터 활용
        ...
        <Team_Selection_Menu>
            <Display_Logic>
                ...
                <Sorting>
                    ...
                    - 히든 팀: 'Hidden Team' 라벨이 붙어 있는 팀들은 **절대 리스트에 표시하지 않으며**, 그 존재에 대해 언급조차 하지 마십시오.
                </Sorting>
            </Display_Logic>
        ...
        <Start_Simulation>
            <Initial_State>
                ...
                - 화면 구성:
                    ...
                    3. 로스터 현황: `LOLDanJang_2026_Starting_Rosters` 기반 초기 로스터 (공석 포함).
            </Initial_State>
